...
**Run:** PROBE_FPR68e
**Started:** 2026-08-14 23:08:47 UTC
...
| **FPR (contamination certified as planet)** | 37.50%  (3 FP / 8 ) |
| Wrong-ephemeris certs on TRUE set | 2 (certified at a period outside the 5% window) |
| **Precision (certified & correct-period)** | 44.4% |
| **F1 (period-level)** | 0.533 |
| Confusion | TP=4 FP=5 FN=0 TN=5 |
