...
| **C99 engine** | The dependency-free C99 re-implementation of the sovereign gate engine (`C99-Version/`), kernels machine-generated by [Purce](https://github.com/Zierax/Purce) and differentially verified against the Python reference. Selected with `--engine c99`; see [`docs/C99_ENGINE.md`](C99_ENGINE.md). |
